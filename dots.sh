...
files="bashrc bash_profile iocanerc muttrc muttrc_aliases sxiv tmux.conf Xdefaults xinitrc vimrc config mplayer mpv themes vim"    # list of files/folders to symlink in homedir
